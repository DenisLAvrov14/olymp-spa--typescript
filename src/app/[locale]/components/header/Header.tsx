...
const Header = () => {
  ...
  // Здесь предполагается, что в файлах локалей есть ключи для services, about, reviews, contacts
  const navLinks = [
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 w-full border-b border-[#35312D] bg-[#1F1D1A] py-2 shadow-md transition-all duration-300 sm:py-3">
